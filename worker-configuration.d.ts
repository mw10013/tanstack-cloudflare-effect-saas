/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c87f54c4e5772e0e74c497b037d00d01)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		AI_GATEWAY_ID: "tces-ai-gateway-production";
		...
		USER_PROVISIONING_WORKFLOW: Workflow<Parameters<import("./src/worker").UserProvisioningWorkflow['run']>[0]['payload']>;
	}
	interface Env {
		KV: KVNamespace;
		R2: R2Bucket;
		...
		TRANSACTIONAL_EMAIL: "noreply@example.com";
		CF_ACCOUNT_ID: "1422451be59cc2401532ad67d92ae773";
		AI_GATEWAY_ID: "tces-ai-gateway-production" | "tces-ai-gateway-int";
		R2_BUCKET_NAME: "tces-r2-production" | "tces-r2-local";
		INVOICE_LIMIT: "5" | "3";
		PORT: string;
		BETTER_AUTH_URL: string;
		BETTER_AUTH_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEMO_MODE" | "TRANSACTIONAL_EMAIL" | "CF_ACCOUNT_ID" | "AI_GATEWAY_ID" | "R2_BUCKET_NAME" | "INVOICE_LIMIT" | "PORT" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "WORKERS_AI_API_TOKEN" | "AI_GATEWAY_TOKEN" | "GOOGLE_AI_STUDIO_API_KEY" | "ANALYTICS_TOKEN" | "R2_S3_ACCESS_KEY_ID" | "R2_S3_SECRET_ACCESS_KEY">> {}
}
